      ...
      <div className="w-full max-w-3xl">
        <div className="text-center mb-4 sm:mb-6">
          ...
          <p className={`${theme.textSecondary} text-sm sm:text-base md:text-lg px-2`}>
            Upload a PDF to get AI-powered summaries in seconds
          </p>
        </div>
        ...
        <div className={`${theme.cardBg} ${isDarkMode ? 'backdrop-blur-xl' : ''} rounded-xl overflow-hidden relative transition-all duration-500`}>
          <div className={`flex border-b ${theme.cardBorder}`}>
            <button
              className={`flex-1 flex items-center justify-center gap-1 sm:gap-2 px-3 sm:px-6 py-2.5 sm:py-3 font-medium transition-all text-sm sm:text-base cursor-pointer bg-linear-to-r from-[#6366F1] to-[#8B5CF6] text-white`}
              disabled
            >
